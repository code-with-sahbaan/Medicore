...
public class AiChatController {
    ...
    @GetMapping("v1/getAllChatMessages")
    public ResponseEntity<BaseResponse<List<GetAllChatMessages>>> getAllChatMessages() throws Exception {
        log.info("Executing getAllChatMessages in AiChatController");
        BaseResponse<List<GetAllChatMessages>> savedWorkout = chatService.getAllChatMessages();
        return new ResponseEntity<>(savedWorkout, HttpStatus.OK);
    }
}
